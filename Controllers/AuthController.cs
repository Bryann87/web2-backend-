    ...
    public class AuthController : ControllerBase
    {
        ...
        public IActionResult Login([FromBody] LoginRequest login)
        {
            try
            {
                ...
                var user = _context.Personas.FirstOrDefault(x => x.Correo == login.Email && x.Activo);
                ...
                if (!_passwordService.VerifyPassword(login.Password, user.Contraseña))
                    return Unauthorized(new { message = "Credenciales inválidas." });
        ...
        public async Task<IActionResult> Register([FromBody] Persona persona)
        {
            ...
            persona.Contraseña = _passwordService.HashPassword(persona.Contraseña);
